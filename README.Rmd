...
Posologyr requires a population pharmacokinetic model written in the specific language of RxODE, and an exponential model of inter-individual variability.
...
The load_ppk_model() function makes it easy to initialise the objects to be used by posologyr. 
