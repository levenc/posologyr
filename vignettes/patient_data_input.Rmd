...
Data for input into `posologyr` is the same type of data input for RxODE::RxODE. As stated in the [RxODE documentation (RxODE datasets)](https://nlmixrdevelopment.github.io/RxODE/articles/RxODE-datasets.html), it is also similar to [data for NONMEM](https://doi.org/10.1002/psp4.12404).
...
EVID
: Event type. Must be 0 for all observations (concentrations from therapeutic drug monitoring).
