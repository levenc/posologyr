...
`EVID = 101` for an instantaneous administration in the first compartment defined in the ppk model: either the central compartment for an IV bolus, or a depot compartment for an oral administration.
...
`EVID = 10101` for a bolus infusion defined by its duration, administered in the first compartment defined in the ppk model.
