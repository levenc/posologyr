...
mod_ganciclovir_Caldes_2009 <- list(
 ...
 theta = c(THETA_cl=7.49, THETA_v1=31.90, THETA_cld=10.20,THETA_v2=32.0,
           THETA_ka=0.895, THETA_baf=0.825),
 omega = lotri::lotri({ETA_cl + ETA_v1 + ETA_ka + ETA_baf ~
     c(0.107,
       0     ,   0.227,
       0     ,       0,   0.464,
       0     ,       0,       0,    0.049)}),
 covariates  = c("ClCr"),
 sigma       = c(additive_a = 0.465, proportional_b = 0.143))
```
