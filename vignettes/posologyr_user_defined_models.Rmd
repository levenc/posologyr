...
1. **psi*`** a named vector of the population estimates of the fixed effects parameters (called THETAs, following NONMEM terminology),
1. **Omega** a named square variance-covariance matrix of the population parameters inter-individual variability}
