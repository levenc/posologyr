...
The variance-covariance matrix of the random effects (KAPPA) for the IOV. As for the `omega` matrix, the names must match the names used in **ppk_model**. The easiest way to define it is with `lotri::lotri()`.
...
See `mod_piperacillin_2cpt_Roberts2010` for an example of model with IOV.
